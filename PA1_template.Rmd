...
```{r}  
    ...
    graph2
```
on weekends, thera is a steady number of steps throughout the day, on weekdays on the other hand, there is a spike in number of steps early in the day, then ther is a decrease of steps in the rest of the day
